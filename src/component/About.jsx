...
const About = () => {
    return (
        <div className="max-w-[1300px] mx-auto text-white flex flex-col items-center justify-center py-20 px-10 xl:px-0">
            ...
            <a href="https://drive.google.com/file/d/1WAPNh6GonIi0GKlR5-tfsAE-P3SZEpQS/view?usp=sharing" className="mt-7 py-4 px-7 bg-[#8750f7] rounded-full font-semibold leading-none flex items-center justify-center text-lg cursor-pointer">
                Tải hồ sơ xuống
